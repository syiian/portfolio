...
const translations = {
    'en': {
      ...
      work: 'Work',
      contact: 'Contact',
      profession: 'A creative, customer centered and innovative graphic designer!',
      cv: 'My CV',
    ...
    'ro': {
      ...
      profession: 'Un designer grafic creativ, centrat pe client și inovator!',
      cv: 'CV-ul Meu',
      servicessectiontitle: 'Servicii',
